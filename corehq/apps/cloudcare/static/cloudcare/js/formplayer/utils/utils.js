...
hqDefine("cloudcare/js/formplayer/utils/utils", function () {
    ...
    Utils.paginateOptions = function (currentPage, totalPages, someNumber) {
        var maxPages = 5;
...
//<% if (pageCount > 1 || (total || pageTotal) > rowRange[0]) { %><!-- TODO: turn these into flags generated by paginateOptions -->
        return {
            startPage: startPage,
            endPage: endPage,
